...
import org.lsposed.corepatch.ZygiskHelper.setStaticBoolean
...
object ReconcilePackageUtilsHook : BaseHook() {
    ...
    override fun hook() {
        ...
        if (!ZygiskHelper.deoptimize(reconcilePackagesMethod)) log("failed to deoptimize reconcilePackages")
