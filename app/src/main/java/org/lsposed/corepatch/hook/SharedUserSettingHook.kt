...
import org.lsposed.corepatch.ZygiskHelper.getOriginInvoker
    ...
    override fun hook() {
        ...
        hookBefore(removePackageMethod) { callback ->
            ...
            for (i in 0 until pkgSize) {
                ...
                val b1 = checkCapabilityInvoker.invoke(packagesSignatures, arrayOf(sharedUserSig, 0)) as Boolean
                val b2 = checkCapabilityInvoker.invoke(sharedUserSig, arrayOf(packagesSignatures, 0)) as Boolean
